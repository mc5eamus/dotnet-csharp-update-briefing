// TASK 1: retarget to net11.0 and upgrade EF Core packages to versions that actually restore.
// TASK 2: apply the schema to a real SQLite database and prove the model still works.
// TASK 3: exercise EF Core 11 changes that are present in this RC, not just documented.
// TASK 4: keep every migration check machine-checked with the Check harness.
